...
urlpatterns = [
    ...
    path('class/<int:pk>/schedule/',
         views.ClassScheduleEventCalenderViewOnly.as_view(),
         name='class_schedule_view'
         ),
    path('class/<int:pk>/schedule/update/',
         views.ClassScheduleEventCalenderViewUpdate.as_view(),
    ...
    path('class/sanction/event/delete/',
         views.class_sanction_schedule_event_delete_view,
         name='class_sanction_event_delete'
         ),
    path('download/<int:pk>/schedule/',
         views.ClassScheduleEventCalenderPDFView.as_view(),
         name='class_schedule_download'
         ),
]
